const auroraTokens = [
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB',
    symbol: 'WETH',
    name: 'Wrapped Ether',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x4e834cdcc911605227eedddb89fad336ab9dc00a',
    symbol: 'AAVE',
    name: 'Aave Token',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x8bec47865ade3b172a928df8f990bc7f2a3b9f79',
    symbol: 'AURORA',
    name: 'Aurora',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x8973c9ec7b79fe880697cdbca744892682764c37',
    symbol: 'BAKED',
    name: 'BakedToken',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xb59d0fdaf498182ff19c4e80c00ecfc4470926e2',
    symbol: 'BAL',
    name: 'Balancer',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x2b9025aecc5ce7a8e6880d3e9c6e458927ecba04',
    symbol: 'BAT',
    name: 'Basic Attention Token',
    decimals: 18,
    logoURI:
      'https://raw.githubusercontent.com/KyberNetwork/ks-assets/main/img/token/BAT.svg',
    tags: ['ethereum'],
  },
  {
    chainId: 1313161554,
    ...
    _scan:
      'https://aurorascan.dev/token/0xdeacf0faa2b80af41470003b5f6cd113d47b4dcd',
    symbol: 'COMP',
    name: 'Compound',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xabe9818c5fb5e751c4310be6f0f18c8d85f9bd7f',
    symbol: 'CREAM',
    name: 'Cream Finance',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xe3520349f477a5f6eb06107066048508498a291b',
    symbol: 'DAI',
    name: 'Dai Stablecoin',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xe301ed8c7630c9678c39e4e45193d1e7dfb914f7',
    symbol: 'DODO',
    name: 'DODO bird',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xea62791aa682d455614eaa2a12ba3d9a2fd197af',
    symbol: 'FLX',
    name: 'Flux Token',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xda2585430fef327ad8ee44af8f1f989a2a91a3d2',
    symbol: 'FRAX',
    name: 'Frax',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xc8fdd32e0bf33f0396a18209188bb8c6fb8747d2',
    symbol: 'FXS',
    name: 'Frax Share',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x94190d8ef039c670c6d6b9990142e0ce2a1e3178',
    symbol: 'LINK',
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xfca152a9916895bf564e3f26a611f9e1e6aa6e73',
    symbol: 'LUNA',
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x1d1f82d8b8fc72f29a8c268285347563cb6cd8b3',
    symbol: 'MKR',
    name: 'Maker',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xd126b48c072f4668e944a8895bc74044d5f2e85b',
    symbol: 'MNFT',
    name: 'MANUFACTORY',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x74974575d2f1668c63036d51ff48dbaa68e52408',
    symbol: 'MODA',
    name: 'moda',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xC42C30aC6Cc15faC9bD938618BcaA1a1FaE8501d',
    symbol: 'wNEAR',
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x885f8CF6E45bdd3fdcDc644efdcd0AC93880c781',
    symbol: 'PAD',
    name: 'NearPad Token',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x8828a5047d093f6354e3fe29ffcb2761300dc994',
    symbol: 'PULSE',
    name: 'Pulse',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x18921f1e257038e538ba24d49fa6495c8b1617bc',
    symbol: 'REN',
    name: 'Republic',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xdc9be1ff012d3c6da818d136a3b2e5fdd4442f74',
    symbol: 'SNX',
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x7821c773a12485b12a2b5b7bc451c3eb200986b1',
    symbol: 'SUSHI',
    name: 'SushiToken',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xFa94348467f64D5A457F75F8bc40495D33c65aBB',
    symbol: 'TRI',
    name: 'Trisolaris',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x984c2505a14da732d7271416356f535953610340',
    symbol: 'UMINT',
    name: 'YouMinter',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x1bc741235ec0ee86ad488fa49b69bb6c823ee7b7',
    symbol: 'UNI',
    name: 'Uniswap',
    decimals: 18,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xb12bfca5a55806aaf64e99521918a4bf0fc40802',
    symbol: 'USDC',
    name: 'USD Coin',
    decimals: 6,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x4988a896b1227218e4a686fde5eabdcabd91571f',
    symbol: 'USDT',
    name: 'TetherUS',
    decimals: 6,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0x098d5b6a26bca1d71f2335805d71b244f94e8a5f',
    symbol: 'UST',
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xf4eb217ba2454613b15dbdea6e5f22276410e89e',
    symbol: 'WBTC',
    name: 'Wrapped BTC',
    decimals: 8,
    logoURI:
  ...
  },
  {
    ...
    _scan:
      'https://aurorascan.dev/token/0xa64514a8af3ff7366ad3d5daa5a548eefcef85e0',
    symbol: 'YFI',
    name: 'yearn.finance',
    decimals: 18,
    logoURI:
